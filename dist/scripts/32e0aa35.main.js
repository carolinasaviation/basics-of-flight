...
define('i18n/en',{
	...
	weight: {
		title: 'Weight',
		description: 'This is a description of the force of weight and its effects on an airplane. This is a description of the force of weight and its effects on an airplane. This is a description of the force of weight and its effects on an airplane.'
	}
});


define('config',['./i18n/en'], function(i18n) {
...
define('views/subnavigation',['lodash'], function(_) {
...
!function (name, definition) {
  if (typeof define == 'function') define('vendor/morpheus',definition)
...
define('pages/controls',['./_page'], function(Page) {
...
define('pages/preflight',['./_page'], function(Page) {
...
define('views/navigation',['lodash'], function(_) {
	// Use mustache-style templating in underscore (escaping by default)
	// evaluate: {[ for (var key in obj) { ]}
	// interpolate: {! firstName !}
	// escape: {{ firstName }}
